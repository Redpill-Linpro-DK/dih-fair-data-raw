...
{
    public class ReceiveFullBatchAbort
    {
        private MessageHandlerHelper MessageHandlerHelper { get; set; }
        private const string queueName = "dataraw-receive-fullbatch-abort";

        public ReceiveFullBatchAbort(MessageHandlerHelper messageHandlerManager)
        {
            MessageHandlerHelper = messageHandlerManager;
        }

        [Singleton] // only allow 1 instance of this to run at any given time ... 
        [FunctionName("dataraw-receive-fullbatch-abort")]
